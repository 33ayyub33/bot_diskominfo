...
ADMIN_IDS = [1156760923]  # Ganti dengan ID admin yang sebenarnya
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Kode asli handle_message Anda di sini
...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    file_path = f"temp_{timestamp}{file_name}" if hasattr(file, 'file_name') else f"temp{timestamp}.jpg"
...
if __name__ == '__main__':
    ...
    # Di bagian registrasi handler (if _name_ == '_main_':)
